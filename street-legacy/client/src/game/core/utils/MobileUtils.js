 ...
 * Storage key can be configured via MobileSettings.setStorageKey()
 */
let MOBILE_SETTINGS_KEY = 'game_mobile_settings'

export const MobileSettings = {
  /**
   * Set the localStorage key for mobile settings
   * @param {string} key - The storage key
   */
  setStorageKey(key) {
    MOBILE_SETTINGS_KEY = key
  },
